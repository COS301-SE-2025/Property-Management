...
import { IonCardHeader, IonCardTitle, IonCardContent, IonCard } from "@ionic/angular/standalone";
import { TableModule } from 'primeng/table';
import { forkJoin, lastValueFrom } from 'rxjs';
import { InventoryUsage, Inventory, InventoryItemApiService, InventoryUsageApiService } from 'shared';
...
@Component({
  ...
  `,
  imports: [IonCardHeader, IonCardTitle, IonCardContent, IonCard, TableModule],
})
