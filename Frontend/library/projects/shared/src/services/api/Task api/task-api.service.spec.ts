  ...
  describe('getQuoteFromTaskId', () => {
    it('should get quotes for a task', () => {
      const mockQuotes: Quote[] = [
        { uuid: 'quote-1', t_uuid: 'task-123', amount: 100, status: 'PENDING', c_uuid: '1', submitted_on: new Date(), doc: '' },
        { uuid: 'quote-2', t_uuid: 'task-123', amount: 150, status: 'APPROVED', c_uuid: '2', submitted_on: new Date(), doc: '' }
      ];
