...
class BuildingService(
    ...
    fun createBuilding(dto: BuildingCreateDto): BuildingResponseDto {
        val propertyImageUrl = dto.propertyImageId?.let { 
    ...
    fun updateBuilding(uuid: UUID, dto: BuildingUpdateDto): BuildingResponseDto? {
    ...
    fun getBuildingsByTrustee(trusteeUuid: UUID): BuildingByTrusteeDto {
        val buildings = buildingRepository.findByTrusteeUuid(trusteeUuid)
