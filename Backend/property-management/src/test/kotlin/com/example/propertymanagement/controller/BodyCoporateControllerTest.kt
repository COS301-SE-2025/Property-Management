...
import com.example.propertymanagement.exception.GlobalExceptionHandler
...
class BodyCoporateControllerTest(
    ...
    //     `when`(bodyCorporateService.getBodyCorporateById(testUuid)).thenReturn(null)
...
//         `when`(bodyCorporateService.deleteBodyCorporate(testUuid)).thenReturn(true)
...
//     }
    ...
    //     `when`(bodyCorporateService.deleteBodyCorporate(testUuid)).thenReturn(false)

    //     mockMvc
    //         .perform(delete("/api/body-corporates/{id}", testUuid))
    //         .andExpect(status().isNotFound)
    //         .andExpect(jsonPath("$.error").value("Body corporate not found"))
    ...
    //     `when`(bodyCorporateService.getBodyCorporateByEmail("missing@corp.com")).thenReturn(null)

    //     mockMvc
    //         .perform(get("/api/body-corporates/email/{email}", "missing@corp.com"))
    //         .andExpect(status().isNotFound)

    //     verify(bodyCorporateService).getBodyCorporateByEmail("missing@corp.com")
    // }
    ...
    //     `when`(bodyCorporateService.getBodyCorporateByUserId("missingUser")).thenReturn(null)

    //     mockMvc
    //         .perform(get("/api/body-corporates/user/{userId}", "missingUser"))
    //         .andExpect(status().isNotFound)

    //     verify(bodyCorporateService).getBodyCorporateByUserId("missingUser")
    // }
