CREATE TABLE notification (
    ...
    recipient_type varchar(50) NOT NULL CHECK (recipient_type IN ('trustee', 'contractor', 'bodycoporate')),
...
CREATE INDEX idx_notification_recipient ON notification (recipient_type, recipient_uuid);
